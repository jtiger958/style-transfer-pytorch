...
parser.add_argument("--style_image_name", type=str, default="vangogh", help="image for getting style")
parser.add_argument("--style_dir", type=str, default="style", help="image folder for getting style")
parser.add_argument("--decay_epoch", type=int, default=30, help="number of epoch that halve learning rate")
